...
Task 1A2-A: implementation and owner verification complete, independent spec/quality review pending (strict side-effect-free QA classification, selected-userData single-instance gate, fixed normal port 8000, bounded QA/legacy diagnostics, and runtime-once/window separation; desktop Node 39 passed, focused Python contracts 47 passed, frontend production build passed, syntax/diff checks passed; no browser, Electron launch, portable build, or DXM action).
