...
$summaryLines.Add("- L2/L3 gate records available: $($result.gateEvidenceCheck)")
$summaryLines.Add("- Gate record note: Only means L2/L3 records were readable; not that L2/L3 passed.")
