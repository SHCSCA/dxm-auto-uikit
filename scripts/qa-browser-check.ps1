  ...
  assertions: {
    ...
    configDisabledReasonVisible: clickedConfig
      && (configPrecheckState.buttonDisabled === false
        ...
        || configPrecheckState.text.includes('\u914d\u7f6e\u68c0\u67e5')
        || configPrecheckState.text.includes('\u914d\u7f6e\u9884\u68c0')),
