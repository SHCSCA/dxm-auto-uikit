...
const result = {
  ...
  assertions: {
    ...
    configEditorNearFirstViewport: clickedConfig
      ...
      && configDensityState.focusedEditorFirstControlBottom !== null
      && configDensityState.focusedEditorFieldCount >= 1
      && configDensityState.focusedEditorTop <= Math.min(720, configDensityState.viewportHeight * 0.74)
    ...
    consoleInlineOperatorForms: consoleLoginFormDomState.hasForm === true
      ...
      && consoleLoginFormDomState.rememberChecked === false
