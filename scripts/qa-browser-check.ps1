...
const result = {
  ...
  assertions: {
    ...
    configDefaultTemplatePackVisible: clickedConfig
      ...
      && configTemplateAdvancedState.primaryDefaultVisible === true
      && configTemplateAdvancedState.defaultStatusVisible === true
      && configTemplateAdvancedState.primaryDefaultText.includes(text.defaultTemplatePack)
