...
const primaryAreas: WorkbenchPrimaryArea[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'draft_edit_save', label: '采集箱编辑保存', short: '存', hint: '从采集箱商品创建只保存任务' },
      { id: 'start_save', label: '浏览器现场', short: '览', hint: '查看真实浏览器和自动助手执行状态' },
    ],
  },
  {
    id: 'review',
    ...
    items: [
      ...
      { id: 'results', label: '报告与证据', short: '果', hint: '确认保存结果、截图和未发布证明' },
    ],
  },
  {
    id: 'system',
        ...
        <div className="sidebar__brand">
          ...
          {!sidebarCollapsed && (
            <div>
              ...
              <span className="sr-only">首页 / 账号与浏览器 / 数据采集认领 / 模板中心 / 采集箱编辑保存 / 浏览器现场 / 任务记录 / 报告与证据 / 系统维护</span>
            </div>
          )}
